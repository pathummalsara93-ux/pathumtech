...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from '@pathumtech/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
const urlA = 'https://www.npmjs.com/package/@pathumtech/baileys'

sock.sendMessage(jid, {
   text: urlA + ' 👆🏻 Check it out!',
   linkPreview: {
      'matched-text': urlA,
      title: '🌱 @pathumtech/baileys',
...
import { prepareWAMessageMedia } from '@pathumtech/baileys'

const urlB = 'https://www.npmjs.com/package/@pathumtech/baileys#readme'
...
sock.sendMessage(jid, {
   ...
   product: {
      ...
      signedUrl: 'https://www.npmjs.com/package/@pathumtech/baileys',
      title: '📦 Premium',
      url: 'https://www.npmjs.com/package/@pathumtech/baileys'
   },
...
```javascript
import { tokenizeCode } from '@pathumtech/baileys'
...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 pathumtech',
   description: '@pathumtech/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   offerCode: '@pathumtech/baileys', // --- Optional
   offerUrl: 'https://www.npmjs.com/package/@pathumtech/baileys', // --- Optional
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: '@pathumtech/baileys',
      offerUrl: 'https://www.npmjs.com/package/@pathumtech/baileys',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://www.npmjs.com/package/@pathumtech/baileys' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
import { getImageProcessingLibrary } from '@pathumtech/baileys'
...
```javascript
// --- Create a new one
sock.newsletterCreate('My Newsletter', '📣 Fresh updates weekly')
...
// --- Update newsletter
sock.newsletterUpdate('1231111111111@newsletter', { name: 'My Newsletter' })

// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 My Newsletter')
...
const group = sock.groupCreate('My Group', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 My Group')
...
sock.updateMemberLabel(jid, 'My Label')
```
...
const community = await sock.communityCreate('My Community', '📣 Fresh updates weekly')
...
// --- Change name
sock.communityUpdateSubject(jid, '📦 My Community')
...
await sock.updateBusinessProfile({
   ...
   websites: ['https://www.npmjs.com/package/@pathumtech/baileys'],
...
This fork is redistributed and maintained by [pathumtech](https://github.com/pathumtech)
